...
import BestBuyers from '../ui/BestBuyers/BestBuyers';
...
test('Explore button in hero section renders in the homepage', () => {
  render(
  <BrowserRouter>
  <WagmiConfig client={client}>
      <HeroSection/>
  ...
  const linkElement = screen.getByTestId('explore_btn')
  expect(linkElement).toBeInTheDocument();
});
